...
export const caseStudy = {
  ...
  description:
    'At Autoparts World, we only sell certified engines. This means that our engines have met rigorous standards set by the industry, ensuring that they are safe, reliable, and efficient. We believe that only certified engines can provide our customers with the peace of mind they deserve.',
  summary: [
