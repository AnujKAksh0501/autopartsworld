  ...
  return (
    <Section title="Customer Satisfaction Is Our Goal" image={{ src: wheels }}>
      <div className="space-y-6 text-base text-neutral-600">
        <p>
          At Autoparts World, used engine warranty is restricted to only
          ...
          Autoparts World warranty doesn&apos;t cover any attached
        ...
        <p>
          Autoparts World is also not accountable for any charges
        ...
        <p>
          ...
          unless the replacement is authorized by Autoparts World during
    ...
    <Section title="" image={{ src: gearStick, shape: 1 }}>
      <div className="space-y-6 text-base text-neutral-600">
        ...
        <p>
          ...
          or parts that were not diagnosed correctly. Autoparts World will
    ...
    <Section title="" image={{ src: engineRepair, shape: 2 }}>
      <div className="space-y-6 text-base text-neutral-600">
        <p>
          ...
          Autoparts World is using a VIN compatibility tool to assure that
        ...
        <p>
          ...
          disassembled or altered in any way without Autoparts World
      ...
      <Container className="mt-24">
        <GridList>
          ...
          <GridListItem className="flex" title="">
            ...
            us. Autoparts World warranty claim representative will work
          ...
          <GridListItem className="flex" title="">
            Autoparts World permits only original purchasers for any deal
  ...
  return (
    <div className="relative mt-24 pt-24 sm:mt-32 sm:pt-32 lg:mt-40 lg:pt-40">
      ...
      <SectionIntro
        ...
        title="Autoparts World warranty applies to the used engines ONLY."
      >
      ...
      <Container className="mt-24">
        <GridList>
          ...
          <GridListItem className="flex" title="7 ">
            Autoparts World warranty does not apply for an initial
            installation. Autoparts World warranty claim must be submitted
    ...
    <>
        ...
        <FadeIn className="flex-column items-center justify-between pt-4 sm:flex md:pt-0">
          ...
          <div className="mx-auto max-w-xl px-2 sm:px-0 sm:pl-16">
            <h1 className="hidden font-display text-2xl font-semibold tracking-tight text-orange-400 [text-wrap:balance] sm:text-3xl sm:text-orange-950 md:block">
              Engines and Drivetrain warranty.
            </h1>
      ...
      <Container className="pt-0 sm:pt-32">
        ...
        <p className="pt-4 font-display text-base">
          At Autoparts World, our products are more than just auto parts;
        ...
        <p className="pt-4 font-display text-base">
          ...
          clearly reflected in Autoparts World warranty policy. We continue
        ...
        <p className="pt-4 font-display text-base">
          Autoparts World recognizes the value of backing up our products
          ...
          Autoparts World to explore the auto parts world confidently. We
      ...
      <Container className="pt-0 sm:pt-32">
        ...
        <p className="pt-4 font-display text-base">
          ...
          engine into motion. Autoparts World recognizes the importance of
      ...
      <div className="mt-12 flex justify-center border-t border-t-neutral-200 pt-36">
        <div className="max-w-5xl px-8 text-center">
          ...
          <p className="py-2">
            Subject to the limitations listed below, Autoparts World says they will
          ...
          <p className="py-2">
            Autoparts World will not be responsible for any labour cost incurred by
      ...
      <Container className="mt-12 flex justify-start pt-36">
        <div>
          ...
          <p className="py-2">
            The Autoparts World liability is solely and exclusively limited to
            ...
            consequential damages. Autoparts World is not responsible for any
          ...
          <p className="py-2">
            Autoparts World offers an extensive engine warranty regardless of the
